...
public:  
  ...
  int degreeV() const //!< A reference to the degree in V of the surface
    { return degV ; }
  int CtrlNumU() { return P.rows();}    //jqq
  int CtrlNumV() { return P.cols();}    //jqq
  ...
  void globalInterpn(const Matrix< Point_nD<T,N> >& Q, Vector<T> vk, Vector<T> uk,int pU, int pV);     //Jqq 2013.12.17
  ...
  void globalInterpClosedUn(const Matrix< Point_nD<T,N> >& Q, Vector<T> uk, Vector<T> vk, int pU, int pV);   //Jqq 2013.12.17
  ...
  void leastSquaresn(const Matrix< Point_nD<T,N> >& Q, Vector<T> uk, Vector<T> vk, int pU, int pV, int nU, int nV) ;   //Jqq 2013.12.17
  void leastSquaresClosedU(const Matrix< Point_nD<T,N> >& Q, int pU, int pV, int nU, int nV) ;
  void leastSquaresClosedUn(const Matrix< Point_nD<T,N> >& Q,  Vector<T> uk, Vector<T> vk, int pU, int pV, int nU, int nV) ;   //Jqq 2013.12.17
  ...
  friend void globalSurfApproxn (const Matrix< Point_nD<T,N> >& Q, Vector<T> uk, Vector<T> vk, int pU, int pV, NurbsSurface<T,N>& S, double error);
...
//jqq 2013.12.17
typedef PLib::NurbsSurface<double,2> PlNurbsSurface_2Dd ;
typedef PLib::NurbsSurface<double,1> PlNurbsSurface_1Dd ;
...
#include "nurbsS.cpp"
//#include "d_nurbsS.cpp"
//#include "f_nurbsS.cpp"
