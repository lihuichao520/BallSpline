...
namespace PLib {
  ...
  */
  ...
  struct HPoint_nD<float,3> {
    ...
    HPoint_nD(): created(1) { x() = y() = z() = w() = T(); }
    HPoint_nD(T d,int c): created(c) { x() = y() = z() = w() = d; } 
    HPoint_nD(T a): created(1) { x() = y() = z() = w() = a; }
    HPoint_nD(T X, T Y, T Z, T W): created(1) { x()=X ; y()=Y; z()=Z; w()=W;}
    HPoint_nD(const HPoint_nD& a): created(1) { memcpy((void*)data,(void*)a.data,4*sizeof(T)); }
    HPoint_nD(const Point_nD<T,3>& a): created(1) { memcpy((void*)data,(void*)a.data,(3)*sizeof(T));  data[3] = T(1); }
    ...
    HPoint_nD& operator=(const HPoint_nD& v) { x()=v.x() ; y()=v.y() ; z()=v.z() ; w()=v.w() ; return *this;}
    ...
    HPoint_nD& operator*=(T v) { x()*=v ; y()*= v ; z()*= v; w()*= v;  return *this; }
    HPoint_nD& operator/=(T v) { x()/=v ; y()/= v ; z()/= v; w()/= v; return *this; }
  ...
  struct HPoint_nD<float,2> {
    ...
    HPoint_nD(): created(1) { x() = y() = w() = T(); }
    HPoint_nD(T d,int c): created(c) { x() = y() = w() = d; } 
    HPoint_nD(T a): created(1) { x() = y() = w() = a; }
    HPoint_nD(T X, T Y, T W): created(1) { x()=X ; y()=Y; w()=W;}
    HPoint_nD(T X, T Y, T Z, T W): created(1) { x()=X ; y()=Y; w()=W;}
    HPoint_nD(const HPoint_nD& a): created(1) { memcpy((void*)data,(void*)a.data,3*sizeof(T)); }
    HPoint_nD(const Point_nD<T,2>& a): created(1) { memcpy((void*)data,(void*)a.data,(2)*sizeof(T));  data[2] = T(1); }
    ~HPoint_nD() { /*if(created) if(data) delete []data ;*/ }
    ...
    HPoint_nD<T,2>& operator=(const HPoint_nD<T,2>& v) { x()=v.x() ; y()=v.y(); w()=v.w(); return *this;}
    ...
    HPoint_nD<T,2>& operator*=(T v) { x()*=v ; y()*= v ; w()*= v ; return *this; }
    HPoint_nD<T,2>& operator/=(T v) { x()/=v ; y()/= v ; w()/= v ; return *this; }
